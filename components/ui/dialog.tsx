...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "absolute top-1/3 z-50 mx-10 grid scale-100 gap-4 rounded-lg bg-white pt-6 opacity-100 animate-in fade-in-90 slide-in-from-bottom-10 sm:max-w-lg sm:zoom-in-90 sm:slide-in-from-bottom-0 md:top-auto md:mx-0",
        "dark:bg-slate-900",
        className,
      )}
      {...props}
